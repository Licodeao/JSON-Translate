...
在进行国际化业务时，可能遇到在提取中文后，需要手动进行翻译的情况。对于庞大的老项目而言，中文字符可想而知，甚至于整个部门的所有项目都需要进行国际化。如果在所有项目都进行提取中文后再来手动进行翻译，工作量可想而知，且效率极其低下。于是，在手动翻译这一环节使用编码进行效率提升。

定好需求后，选择了 Google translate api，但发现好像最近 api 的某个字段改了，导致接口使用不了。故而想到了离线翻译，但离线翻译针对于某些业务场景名词可能翻译的不够准确。所以，还是选择联网翻译，最终选择了使用百度翻译，其免费额度相对来说已经够用...
